...
urlpatterns = [
    ...
    url(r'^faculty/(?P<notification>\w*)', faculty, name='faculty'),
    url(r'^gymkhana/(?P<notification>\w*)', gymkhana, name='gymkhana'),
    url(r'^student/(?P<notification>\w*)', student, name='student'),
    url(r'^admindashboard/(?P<notification>\w*)', admindashboard, name='admindashboard'),
